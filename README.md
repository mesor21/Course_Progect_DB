...
```
## Страницы фронтенда
1. [x] Оснавная с выбором действия
   ...
   3. [x] Запросы
      1. [x] По дате найти все маршруты и количество автобусов на нём
      2. [x] По дате и номеру маршрута вся информация об автобусах
      3. [x] За месяц подсчитать количество рейсов на маршруте или автобусом
      4. [x] За полгода расчитать количество смен кондукторами и водителями
